...
#define MEH_RBC MT(MOD_MEH,  KC_RBRC) //  ]       Super
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+-------------|      |------+------+------+------+------+------+------+------|
   * | Ctrl |   [  |   ]  | Alt  |||||||| Lower| Bksp | Tab  |      | Enter| Space| Raise|||||||| Left | Down |  Up  | Right|
   * ,-------------------------------------------------------.      `-------------------------------------------------------.
   *
   * ,------------------------------------------------.                    ,------------------------------------------------.
  ...
  [_QWERTY] = LAYOUT(
	  ...
	  CTL_ESC, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  HPR_MIN,   SUP_EQL,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
   ...
   * |------+------+------+------+------+------+-------------.      ,------+------+------+------+------+------+------+------|
   * |      |  _   |   "  |   ~  |   +  | PgDn |             |      |             | Home | PgDn | PgUp | End  |      |      |
   * |-------------+------+------+------+------+-------------|      |------+------+------+------+------+------+------+------|
   * | Mou2 | Mou3 | Mou1 |      |||||||| LOWER|      |      |      |      |      |Adjust|||||||| Shift| Alt  | Ctrl |      |
   * ,-------------------------------------------------------.      `-------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
  ...
  [_RAISE] = LAYOUT(
	  ...
	  _______, _______, _______, _______, _______, _______, _______, _______, _______, RAISE  , KC_DOT , KC_0   , KC_PLUS, _______
	  ),
