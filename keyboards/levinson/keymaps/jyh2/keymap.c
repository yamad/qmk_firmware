 ...
 */
	[_QW] = KEYMAP(
		...
		KC_TAB , MEH_LBC, KC_LGUI, KC_LALT, LOWER  , CTL_BSP, KC_SPC , RAISE  , KC_RALT, KC_RGUI, HPR_RBC, KC_ENT
		),
 ...
 * |      |  [   |  ]   |  (   |  )   |  ,   |    |  -   |  1   |  2   |  3   |  /   |  =   |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * | Numpd|      |      |Adjust|      |      |    |      | RAISE|   .  |  0   |  +   | Enter|
 * `-----------------------------------------'    `-----------------------------------------'
 */
	[_RS] = KEYMAP(
		_______, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , _______,
		_______, KC_LEFT, KC_UP  , KC_DOWN, KC_RGHT, KC_SCLN, KC_QUOT, KC_4   , KC_5   , KC_6   , KC_ASTR, _______,
		_______, KC_LBRC, KC_RBRC, KC_LPRN, KC_RPRN, KC_COMM, KC_MINS, KC_1   , KC_2   , KC_3   , KC_SLSH, _______,
		TT(_NM), _______, _______, _______, _______, _______, _______, _______, KC_DOT , KC_0   , KC_PLUS, _______
		),
 ...
 */
	[_LW] = KEYMAP(
		...
		TT(_NM), _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______
		),
 ...
 * |      |  1   |  2   |  3   |  4   |  5   |    |  6   |  7   |  8   |  9   |  0   |      |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |      | Caps | Ins  | Home | PgUp |      |    |      |  4   |  5   |  6   |  /   |      |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |      | NmLk | Del  | End  | PgDn |      |    |      |  1   |  2   |  3   |  *   |  =   |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |QWERTY|      |      |      |      |      |    |      |  0   |  .   |  +   |  -   | Enter|
 * `-----------------------------------------'    `-----------------------------------------'
 */
	[_NM] = KEYMAP(
		_______, KC_1   , KC_2   , KC_3   , KC_4   , KC_5   ,    KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , _______,
		_______, KC_CAPS, KC_INS , KC_HOME, KC_PGUP, _______,    _______, KC_4   , KC_5   , KC_6   , KC_SLSH, _______,
		_______, KC_NLCK, KC_DEL , KC_END , KC_PGDN, _______,    _______, KC_1   , KC_2   , KC_3   , KC_ASTR, KC_EQL ,
		TO(_QW), _______, _______, _______, _______, _______,    _______, KC_0   , KC_DOT , KC_PLUS, KC_MINS, _______
		),
 ...
 * | Reset|      |  Up  |      |      | Rec1 |    | Rec2 |      |      |      |      |      |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |      | Left | Down | Right|      | Play1|    | Play2| LED+-| LED  |      |      |      |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |      |      |      |      |      | Stop1|    | Stop2|      |      |      |      |      |
 * |------+------+------+------+------+------|    |------+------+------+------+------+------|
 * |QWERTY|      |      |      |      |      |    |      |      |      |      |      |      |
 ...
 */
	[_ADJUST] = KEYMAP(
		...
		_______, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX, DPLAY_1,    DPLAY_2, BL_STEP, BL_TOGG, XXXXXXX, XXXXXXX, _______,
		_______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, DSTOP  ,    DSTOP  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
		TO(_QW), _______, _______, _______, _______, _______,    _______, _______, _______, _______, _______, _______
		)
};
